...
* The original package name 'com.example.oauth2.tutorial.resource-server' is invalid and this project uses 'com.example.oauth2.tutorial.resourceserver' instead.
