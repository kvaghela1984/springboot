...
* The original package name 'com.example.oauth2.tutorial.oauth2-client-server' is invalid and this project uses 'com.example.oauth2.tutorial.oauth2clientserver' instead.
